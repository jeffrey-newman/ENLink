...
#define   MAXID_ADD_ONE   16          // JN Modified
#define   EN_MAX_ID_LEN          15 // Max. # characters in ID name
#define   EN_MAX_ID_LEN_ADD_ONE  16        // JN Modified


struct IDstring    /* Holds component ID labels */
{
    char ID[EN_MAX_ID_LEN_ADD_ONE];     // JN Modified
};
...
{
    int        i;
    char       ID[MAXID_ADD_ONE];     // JN Modified
    SFloatlist *x;
    SFloatlist *y;
    struct     Tmplist  *next;
};
...
{
    char  ID[MAXID_ADD_ONE]; /* Pattern ID       */     // JN Modified
...
{
    char  ID[MAXID_ADD_ONE]; /* Curve ID         */     // JN Modified
    int   Type;        /* Curve type       */
...
{
    char   ID[MAXID_ADD_ONE];    /* Node ID          */     // JN Modified
    float  El;             /* Elevation        */
...
{
    char   ID[MAXID_ADD_ONE];    /* Link ID           */     // JN Modified
...
{
    char  Name[MAXID_ADD_ONE];   /* Name of reported variable  */      // JN Modified
    char  Units[MAXID_ADD_ONE];  /* Units of reported variable */      // JN Modified
